...
public class MainActivity extends AppCompatActivity {
    ...
    private void AnhXa() {
        ...
        destinationArrayList.add(new Destination("Ba Na Hills", "1.000.000 VND", "Đà Nẵng","Đến với Sun World Ba Na Hills, du khách có cơ hội được thăm quan và trải nghiệm những công trình và điểm đến độc đáo, có một không hai. ", R.drawable.banahill));
